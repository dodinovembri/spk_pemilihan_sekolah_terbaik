                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tbody>
                                                <?php $no = 0;
                                                foreach ($alternative_accessibility as $key => $value) {
                                                    $no++; ?>
                                                    <tr>
                                                        <td><?php echo $no; ?></td>
                                                        ...
                                                        <?php if ($this->session->userdata('role_id') != 3) { ?>
                                                            <td>
                                                                <a href="<?php echo base_url('alternative_accessibility/edit/');
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="<?php echo base_url('alternative_accessibility/destroy/');
