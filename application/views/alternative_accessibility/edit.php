                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h6 class="mb-sm-0">
                                        ...
                                        <b>></b> 
                                        <span>Edit Aksesibilitas</span></h6>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="<?php echo base_url('alternative_accessibility/update/'); echo $alternative_accessibility->id ?>" enctype="multipart/form-data">
                                            <div class="mb-3 row">
