                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="<?php echo base_url('alternative_location/update/'); echo $alternative_location->id ?>" enctype="multipart/form-data">
                                            <div class="mb-3 row">
