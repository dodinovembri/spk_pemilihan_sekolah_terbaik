                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="<?php echo base_url('alternative_facility/update/'); echo $alternative_facility->id ?>" enctype="multipart/form-data">
                                            <div class="mb-3 row">
