                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php } ?>
                                        <form method="POST" action="<?php echo base_url('school/update/'); echo $school->id ?>" enctype="multipart/form-data">
                                            <div class="mb-3 row">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-md-10">
                                                    <img height="150px" src="<?php echo base_url('uploads/alternative/'); echo $school->image ?>">
