                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                            ...
                                            <tbody>
                                            <?php $no = 0; foreach ($alternative_extracurricular as $key => $value) { $no++; ?>
                                                <tr>
                                                    <td><?php echo $no; ?></td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('alternative_extracurricular/edit/'); echo $value->id; ?>"><i class="far fa-edit" style="margin: 2px"></i></a> 
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="<?php echo base_url('alternative_extracurricular/destroy/'); echo $value->id; ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
