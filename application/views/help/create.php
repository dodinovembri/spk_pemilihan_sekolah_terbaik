                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="<?php echo base_url('help/store') ?>">
                                            <div class="mb-3 row">
                                                <label for="example-search-input" class="col-md-2 col-form-label">Kode Help</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" name="help_code" placeholder="Kode Help" required="">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label for="example-search-input" class="col-md-2 col-form-label">Judul</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" name="title" placeholder="Judul Help" required="">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label for="example-email-input" class="col-md-2 col-form-label">Deskripsi Kriteria</label>
                                                <div class="col-md-10">
                                                    <textarea class="form-control" id="editor" rows="7" name="description" required> </textarea>
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
