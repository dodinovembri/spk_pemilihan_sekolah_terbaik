                                        ...
                                        <div class="card-body">
                                            <form method="POST" , action="<?php echo base_url('ranking') ?>">
                                                ...
                                                <div class="button-items">
                                                    <button type="submit" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="right" title="" data-bs-original-title="Perbaharui koordinat lokasi anda">
                                                    Refresh Location
                                                    </button><br><br>
                                                </div>
                                            </form>
                                                ...
                                                <tbody>
                                                    <?php foreach ($v_vector as $key => $value) { ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php if ($value['distance'] == "not_defined") {
                                                                    echo "Refresh Location";
                                                                } else {
                                                                    echo $value['distance'] . " Km";
                                                                } ?></td>
                                                            <td><?php echo $value['v_vector']; ?></td>
                                                            <td><a href="<?php echo base_url('alternative/show/');
                                                                            echo $query->row()->id; ?>"><i class="far fa-eye" style="margin: 2px"></i></a> </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
